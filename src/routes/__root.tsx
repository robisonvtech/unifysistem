...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "RepairAI — Assistente Unify" },
      { property: "og:description", content: "IA especialista em reparo de celulares para técnicos e revendedores." },
